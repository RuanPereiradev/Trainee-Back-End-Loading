...
export async function projectRoutes(app:FastifyInstance) {
    ...
    app.get("/projects/pagination", {preHandler: [authMiddleware,requireCoordenadorOrDirector]},(request, reply) => projectController.listPagineted(request, reply));
    ...
    app.put("/projects/:id",{preHandler: [authMiddleware, requireCoordenadorOrDirector ]},(request, reply) => projectController.updateProject(request, reply));
    ...
    app.patch("/projects/:id/restore",{preHandler: [authMiddleware, requireCoordenadorOrDirector]},(request, reply) => projectController.restore(request, reply));
